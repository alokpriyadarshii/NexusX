...
from tests.compat import assert_true, assert_false
...
class GoodbyeWorld(flask_nexusx.Resource):
...
class APIWithBlueprintTestCase(unittest.TestCase):
    ...
    def test_api_base(self):
        ...
        api = flask_nexusx.Api(blueprint)
        app = Flask(__name__)
    ...
    def test_url_with_api_prefix(self):
        blueprint = Blueprint('test', __name__)
        api = flask_nexusx.Api(blueprint, prefix='/api')
    ...
    def test_url_part_order_aeb(self):
        blueprint = Blueprint('test', __name__, url_prefix='/bp')
        api = flask_nexusx.Api(blueprint, prefix='/api', url_part_order='aeb')
        api.add_resource(HelloWorld, '/hi', endpoint='hello')
        app = Flask(__name__)
        app.register_blueprint(blueprint)
