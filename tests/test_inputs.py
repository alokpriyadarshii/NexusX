...
from tests.compat import assert_equal, assert_raises
import six

from flask_nexusx import inputs
...
def test_urls():
    urls = [
        ...
        'http://localhost/',
        'http://alokpriyadarshi618.test/',
        'http://www.alokpriyadarshi618.test/',
        'http://www.alokpriyadarshi618.test:8000/test',
        'http://valid-with-hyphens.com/',
        'http://subdomain.alokpriyadarshi618.test/',
        'http://200.8.9.10/',
        'http://200.8.9.10:8000/test',
        'http://valid-----hyphens.com/',
        'http://alokpriyadarshi618.test?something=value',
        'http://alokpriyadarshi618.test/index.php?something=value&another=value2',
        'http://alok:pass@localhost',
        'http://alok:@localhost',
        'http://foo:@2001:db8:85a3::8a2e:370:7334',
        'http://alok2:qd1%r@localhost',
    ]
...
def test_bad_url_error_message():
    values = [
        'alokpriyadarshi618.test',
        'domain.alokpriyadarshi618.test',
        'alok:pass@localhost/path?query',
        u'alokpriyadarshi618.test/path?\u2713',
    ]
...
class TypesTestCase(unittest.TestCase):
    ...
    def test_boolean_with_numeric_values(self):
        assert_equal(inputs.boolean(1), True)
        assert_equal(inputs.boolean(0), False)
