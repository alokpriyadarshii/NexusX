...
from flask_nexusx.reqparse import Argument, RequestParser, Namespace
import six
import decimal
...
class ReqParseTestCase(unittest.TestCase):
    ...
    @patch('flask_nexusx.abort', side_effect=exceptions.BadRequest('Bad Request'))
    ...
    @patch('flask_nexusx.reqparse.six')
